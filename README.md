...
Both mods set the game's `isGameplayAltered` flag, which is the intended behaviour for
gameplay mods. The authors' code of conduct asks that gameplay-altering mods not be taken
into games with people who have not agreed to them.
